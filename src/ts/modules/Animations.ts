...
export class Animations extends Helpers {
     ...
     * @return {void | boolean}
     */
    public navigated(navigators: string | object | any, navigateds: string | object | any, active: string = 'active', tolerance:number = 0): void | boolean {
